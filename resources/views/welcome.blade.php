        ...
        <div class="container max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div class="flex flex-col gap-8 max-w-2xl reveal stagger-1">
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-black text-brand-primary leading-[1.2]">
                    <div class="overflow-hidden"><span class="block hero-text-line">{{ __('نبني المستقبل') }}</span></div>
                    <div class="overflow-hidden"><span class="block hero-text-line"><span class="text-brand-secondary">{{ __('بحرفية') }}</span> {{ __('وتميز') }}</span></div>
                </h1>
                
                <div class="overflow-hidden">
                    <p class="text-lg md:text-xl text-brand-muted border-r-4 border-brand-tertiary pr-6 leading-relaxed hero-text-line" dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}" style="border-right: {{ app()->getLocale() == 'ar' ? '4px' : '0' }} solid; border-left: {{ app()->getLocale() == 'en' ? '4px' : '0' }} solid; border-color: #D4A373;">
                        {{ __('نصنع فارقاً في عالم المقاولات بتصاميم عصرية وتنفيذ احترافي يضمن أعلى معايير الجودة العالمية منذ أكثر من عقدين. نحن وادي الريان، شريكك الموثوق.') }}
                    </p>
                </div>
                ...
                <div class="flex flex-wrap gap-4 mt-4 overflow-hidden">
                    <a href="/contact" class="hero-btn inline-flex justify-center items-center px-8 py-4 text-lg font-bold text-white rounded-lg shadow-card transition-all duration-500 bg-brand-secondary hover:bg-brand-primary hover:shadow-soft hover:-translate-y-1">
                        {{ __('ابدأ مشروعك') }}
                        <svg class="mx-3 w-5 h-5 rtl:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                    </a>
    ...
    <section class="bg-brand-primary py-20 w-full relative overflow-hidden">
        ...
        <div class="container max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
            <div class="flex flex-col items-center text-center px-4">
                ...
                <span class="text-sm md:text-base font-bold text-white/70 mt-2 uppercase tracking-widest">{{ __('عاماً من الخبرة') }}</span>
            </div>
            <div class="flex flex-col items-center text-center px-4">
                <span class="text-5xl md:text-6xl font-black text-white">150+</span>
                <span class="text-sm md:text-base font-bold text-white/70 mt-2 uppercase tracking-widest">{{ __('مشروع مكتمل') }}</span>
            </div>
            <div class="flex flex-col items-center text-center px-4">
                <span class="text-5xl md:text-6xl font-black text-white">100%</span>
                <span class="text-sm md:text-base font-bold text-white/70 mt-2 uppercase tracking-widest">{{ __('التزام بالمواعيد') }}</span>
            </div>
            <div class="flex flex-col items-center text-center px-4">
                <span class="text-5xl md:text-6xl font-black text-brand-tertiary">24/7</span>
                <span class="text-sm md:text-base font-bold text-white/70 mt-2 uppercase tracking-widest">{{ __('دعم فني هندسي') }}</span>
            </div>
        </div>
    </section>
    ...
    <section id="services" class="py-24 bg-white border-t border-gray-100">
        <div class="container max-w-7xl px-4 mx-auto md:px-6">
            <div class="text-center mb-20 max-w-3xl mx-auto">
                ...
                <h2 class="text-4xl md:text-5xl font-extrabold text-brand-primary mb-6">{{ __('مجالات التميز الهندسي') }}</h2>
                <p class="text-lg text-brand-muted leading-relaxed">
                    {{ __('نقدم حلولاً إنشائية وهندسية متكاملة عبر فريق من الخبراء لضمان تنفيذ مشاريعكم بأعلى معايير الجودة والسلامة المهنية.') }}
                </p>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                @forelse($services->take(3) ?? [] as $service)
                    <div class="bg-white border-b-4 border-transparent hover:border-brand-secondary border-x border-t border-gray-100 p-10 rounded-xl shadow-card hover:shadow-soft transition-all duration-500 group">
                        <div class="mb-6 group-hover:text-brand-secondary text-brand-primary transition-colors duration-300">
                            {!! $service->icon ?? '<svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>' !!}
                        </div>
                        <h3 class="mb-4 text-2xl font-bold text-brand-primary">{{ $service->title }}</h3>
                ...
                @empty
                    ...
                    <div class="bg-white border-b-4 border-transparent hover:border-brand-secondary border-x border-t border-gray-100 p-10 rounded-xl shadow-card hover:shadow-soft transition-all duration-500 group">
                        ...
                        <h3 class="mb-4 text-2xl font-bold text-brand-primary">{{ __('بناء عام') }}</h3>
                        <p class="font-medium leading-relaxed text-brand-muted/90">
                            {{ __('نقوم بتنفيذ أضخم المشاريع الإنشائية، بدءاً من الأبراج السكنية والمراكز التجارية وصولاً إلى المجمعات المتكاملة، مع التزام تام بالجودة.') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-white border-b-4 border-transparent hover:border-brand-secondary border-x border-t border-gray-100 p-10 rounded-xl shadow-card hover:shadow-soft transition-all duration-500 group">
                        ...
                        <h3 class="mb-4 text-2xl font-bold text-brand-primary">{{ __('ترميم المباني') }}</h3>
                        <p class="font-medium leading-relaxed text-brand-muted/90">
                            {{ __('إعادة إحياء المباني القائمة وتحديثها عبر أحدث التقنيات لضمان استدامتها وحمايتها، مع الحفاظ على القيمة الجمالية والمعمارية.') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-white border-b-4 border-transparent hover:border-brand-secondary border-x border-t border-gray-100 p-10 rounded-xl shadow-card hover:shadow-soft transition-all duration-500 group">
                        ...
                        <h3 class="mb-4 text-2xl font-bold text-brand-primary">{{ __('تصميم هندسي') }}</h3>
                        <p class="font-medium leading-relaxed text-brand-muted/90">
                            {{ __('تقديم تصاميم معمارية وإنشائية مبتكرة تجمع بين الجمال الوظيفي والحلول المستدامة لتلبي طموحات عملائنا بدقة واحترافية.') }}
                        </p>
                    </div>
                @endforelse
            </div>
    ...
    <section class="py-24 bg-brand-background border-t border-gray-100">
        <div class="container max-w-7xl px-4 mx-auto md:px-6">
            <div class="flex flex-col justify-between items-end mb-16 md:flex-row">
                <div class="max-w-2xl text-[{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}]">
                    ...
                    <h2 class="text-4xl md:text-5xl font-extrabold text-brand-primary">{{ __('سجل حافل بالإنجازات') }}</h2>
                </div>
                    ...
                    <a href="{{ route('projects.show', $project) }}" class="flex flex-col h-full rounded-2xl bg-white border border-gray-100 shadow-card hover:shadow-soft transition-all duration-500 group overflow-hidden hover:-translate-y-2">
                        <div class="relative overflow-hidden aspect-video bg-gray-100">
                            ...
                            <div class="absolute top-4 left-4 px-4 py-1.5 text-xs font-bold rounded-full shadow-md bg-white text-brand-primary border border-gray-100">
                                {{ $project->completed_at ? \Carbon\Carbon::parse($project->completed_at)->format('Y/m/d') : __('قريباً') }}
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col flex-grow justify-between p-8">
                            <div>
                                <div class="flex justify-between items-center mb-4">
                                    <span class="px-3 py-1 text-xs font-bold tracking-wider rounded-full text-brand-secondary bg-brand-secondary/10">{{ $project->location ?? __('الرياض') }}</span>
                                </div>
                                ...
                                <p class="mb-6 text-base font-medium leading-relaxed text-brand-muted line-clamp-3">
                                    {{ Str::limit(strip_tags($project->description ?? __('تفاصيل المشروع غير متوفرة حالياً. نحن في وادي الريان نهتم بأدق التفاصيل في كل مشاريعنا لضمان الجودة.')), 120) }}
                                </p>
                            </div>
                    ...
                    @foreach(range(1, 3) as $i)
                        <a href="#" class="flex flex-col h-full rounded-2xl bg-white border border-gray-100 shadow-card hover:shadow-soft transition-all duration-500 group overflow-hidden hover:-translate-y-2">
                            ...
                            <div class="flex flex-col flex-grow justify-between p-8">
                                <div>
                                    <div class="flex justify-between items-center mb-4">
                                        <span class="px-3 py-1 text-xs font-bold tracking-wider rounded-full text-brand-secondary bg-brand-secondary/10">{{ __('سيئون، حضرموت، الجمهورية اليمنية') }}</span>
                                    </div>
                                    <h3 class="mb-4 text-2xl font-bold text-brand-primary transition-colors group-hover:text-brand-secondary">{{ __('مجمع سكني نموذجي') }}</h3>
                                    <p class="mb-6 text-base font-medium leading-relaxed text-brand-muted line-clamp-3">
                                        {{ __('مشروع سكني متكامل يضم مجموعة من الفلل الفاخرة المصممة بأحدث الطرازات المعمارية التي تلبي احتياجات العائلة العصرية.') }}
                                    </p>
                                </div>
                                <div class="flex items-center text-sm font-bold text-brand-primary transition-colors group-hover:text-brand-secondary">
                                    {{ __('عرض التفاصيل') }}
            ...
            <div class="grid grid-cols-1 gap-16 items-center lg:grid-cols-2">
                <div class="relative">
                    ...
                    <div class="absolute -bottom-8 -right-8 p-8 rounded-2xl border border-gray-100 shadow-card z-20 hidden md:flex flex-col items-center justify-center min-w-[220px] bg-white">
                        ...
                        <span class="text-sm font-bold tracking-widest text-brand-muted uppercase">{{ __('عاماً من التميز') }}</span>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <h2 class="text-4xl md:text-5xl font-extrabold leading-tight text-brand-primary">
                        {{ __('شريكك الموثوق في البناء والتشييد') }}
                    </h2>
                    <div class="w-20 h-1.5 bg-brand-secondary rounded-full"></div>
                    <p class="text-lg font-medium leading-relaxed text-brand-muted">
                        {{ __('في وادي الريان للمقاولات، نلتزم بتقديم مشاريع نموذجية تجسد التطور وتلبي أعلى المعايير الهندسية. نسعى دائماً لتخطي توقعات عملائنا من خلال الدمج بين التكنولوجيا الحديثة والخبرات المتراكمة.') }}
                    </p>
                    ...
                    <a href="/contact" class="inline-flex items-center gap-3 text-brand-primary font-bold hover:text-brand-secondary transition-colors mt-4 w-fit group">
                        <span class="border-b-2 border-brand-tertiary pb-1 group-hover:border-brand-secondary transition-colors">{{ __('تواصل مع فريقنا') }}</span>
                        <span class="p-2 rounded-full bg-brand-tertiary/20 text-brand-tertiary group-hover:bg-brand-secondary group-hover:text-white transition-all duration-300">
                            <svg class="w-5 h-5 rtl:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                        </span>
                    </a>
