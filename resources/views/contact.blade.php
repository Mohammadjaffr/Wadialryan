<x-layouts.app>
    <x-slot:title>اتصل بنا - وادي الريان للمقاولات</x-slot>
    ...
    <section class="relative pt-40 pb-24 bg-brand-surface flex items-center justify-center overflow-hidden border-b border-white/5">
        <div class="container mx-auto px-4 text-center relative z-10">
            <div class="mb-4">
                <span class="inline-block text-brand-orange font-bold tracking-[0.2em] uppercase text-sm mb-2 px-4 py-1 bg-brand-orange/10 rounded-full">تواصل معنا</span>
            </div>
            <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-6">لنتحدث حول مشروعك القادم</h1>
            <p class="text-lg text-gray-400 max-w-2xl mx-auto font-medium leading-relaxed">فريقنا مستعد لتحويل رؤيتك إلى واقع ملموس. تواصل معنا اليوم لنبدأ رحلة البناء.</p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-brand-surface p-6 rounded-2xl border border-gray-800 flex items-start gap-5 hover:shadow-md transition-shadow">
                            ...
                            <div>
                                <h4 class="font-bold text-white mb-1">المقر الرئيسي</h4>
                                <p class="text-gray-400 font-medium text-sm leading-relaxed">سيئون، حضرموت،<br>الجمهورية اليمنية</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-brand-surface p-6 rounded-2xl border border-gray-800 flex items-start gap-5 hover:shadow-md transition-shadow">
                            ...
                            <div>
                                <h4 class="font-bold text-white mb-1">تواصل هاتفياً</h4>
                                <p class="text-gray-400 font-medium text-sm dir-ltr text-right" dir="ltr">+967 700 000 000</p>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-8">
                    <div class="bg-brand-surface p-8 md:p-12 rounded-3xl border border-gray-800 shadow-xl shadow-brand-dark/50">
                        <h2 class="text-2xl font-bold text-white mb-2">أرسل رسالة</h2>
                        <p class="text-gray-400 font-medium mb-10">يرجى تعبئة النموذج أدناه وسنقوم بالرد في أقرب وقت.</p>
                        ...
                        <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                            ...
                            <!-- Input Group -->
                            <div>
                                <label for="name" class="block text-gray-300 font-bold mb-2 text-sm">الاسم الكامل <span class="text-red-500">*</span></label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="email" class="block text-gray-300 font-bold mb-2 text-sm">البريد الإلكتروني <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="phone" class="block text-gray-300 font-bold mb-2 text-sm">رقم الهاتف</label>
                                    <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="w-full bg-brand-dark border border-gray-800 rounded-xl py-3 px-4 text-white focus:outline-none focus:ring-2 focus:ring-brand-orange/50 focus:border-brand-orange transition-colors dir-ltr text-right">
                                    @error('phone') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                                </div>
                            </div>

                            <div>
                                <label class="block text-gray-300 font-bold mb-2 text-sm">نوع الخدمة المطلوبة</label>
                                <div class="relative">
                                    <select name="service_requested" class="w-full bg-brand-dark border border-gray-800 rounded-xl py-3 px-4 pr-10 text-white appearance-none focus:outline-none focus:ring-2 focus:ring-brand-orange/50 focus:border-brand-orange transition-colors cursor-pointer">
                                        ...
                                        <option value="البناء والمقاولات" {{ old('service_requested') == 'البناء والمقاولات' ? 'selected' : '' }}>البناء والمقاولات العامة</option>
                                        <option value="التصميم المعماري" {{ old('service_requested') == 'التصميم المعماري' ? 'selected' : '' }}>التصميم المعماري والاستشارات</option>
                                        <option value="البنية التحتية" {{ old('service_requested') == 'البنية التحتية' ? 'selected' : '' }}>مشاريع البنية التحتية</option>
                                        <option value="أخرى" {{ old('service_requested') == 'أخرى' ? 'selected' : '' }}>أخرى / استفسار عام</option>
                                    </select>
                            ...
                            <div>
                                <label for="message" class="block text-gray-300 font-bold mb-2 text-sm">تفاصيل المشروع أو الاستفسار <span class="text-red-500">*</span></label>
                            ...
                            <div class="pt-4">
                                <button type="submit" class="w-full bg-brand-orange text-white font-bold py-4 px-6 rounded-full hover:bg-brand-amber transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 flex justify-center items-center gap-3 group">
                                    إرسال الطلب الآن
                                    <svg class="w-5 h-5 group-hover:-translate-x-1 transition-transform rtl:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                                </button>
                            </div>
                        </form>
                    </div>
