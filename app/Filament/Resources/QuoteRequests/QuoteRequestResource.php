...
{
    protected static ?string $modelLabel = 'طلب تسعير';
    protected static ?string $pluralModelLabel = 'طلبات التسعير';
    protected static ?string $navigationLabel = 'طلبات التسعير';
